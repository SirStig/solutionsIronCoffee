...
export const projects: Project[] = [
  {
    ...
    title: 'Ourlee',
    description:
      'A Christianity-focused couples app for two—one shared, glass-morphic space for your calendar, photos, notes, plans, goals, faith, and live location. Built from a single Expo + React Native Web codebase against a FastAPI backend, shipping to iOS, Android, and web at once. Internal shared calendar with two-way Google, Apple CalDAV, and Apple EventKit sync; photos and albums; markdown notes; trips, a date-idea jar, and a shared Drive; goals with milestones; a daily Bible verse with devotionals and a prayer log; a cooperative "In Step" couples game; live location sharing with places and geofences; and home-screen widgets on both platforms. By design there is no AI—content is hand-curated and Christianity-rooted. Currently in closed beta.',
    longDescription:
      'Ourlee is a private, glass-morphic app for one couple to share their whole life together: an internal shared calendar that\'s the source of truth (with optional two-way sync to Google Calendar, Apple CalDAV, and Apple EventKit), shared and private markdown notes, photos and short videos in albums with reactions, trips and date plans plus a shared date-idea jar and a "don\'t forget" list, goals with milestones, a faith layer—daily Bible verse, multi-day devotional series, and a prayer log—and a cooperative "In Step" game with daily challenges, quick rounds, and 7-day journeys that reveal answers together once both partners submit. Live location sharing adds places and geofences so partners know when the other has left or arrived, tuned to sip battery rather than drain it. A shared Drive holds couple files beyond photos, one-tap "Pulses" send a quick thinking-of-you/love-you/praying-for-you nudge, and native iOS WidgetKit + Android home-screen widgets surface the daily verse, next event, a prayer prompt, and a streak without ever calling an authenticated endpoint. Everything syncs between partners in real time over WebSockets, with partner-activity and reminder push notifications. It is built from a single Expo SDK 55 + React Native + React Native Web codebase (TypeScript, expo-router, NativeWind, Zustand, TanStack Query, Reanimated) against a FastAPI backend (SQLAlchemy 2.0 async, Postgres via Supabase, Redis with yokedcache, Cloudflare R2 for media), with RevenueCat and Stripe for billing. By design there are no user-facing AI features—everything is hand-curated and Christianity-rooted. Dark and spacious with a golden-ratio rhythm and two themes (Aurora Dark, plus a premium Rosewood). An IronCoffee LLC product, currently in closed beta on iOS, Android, and web at ourlee.app.',
    technologies: [
      'Expo',
      'React Native',
      'React Native Web',
    ...
    features: [
      'One shared calendar—date nights, trips, anniversaries—with two-way sync to Google Calendar, Apple CalDAV, and Apple EventKit',
      'Shared and private notes in markdown, beautifully rendered',
      'Photos and short videos in albums with reactions, stored to Cloudflare R2',
      'Plans and trips with itineraries, a shared date-idea jar, a "don\'t forget" list, and a shared Drive for couple files',
      'Goals with milestones that celebrate together as you hit them',
      'Faith layer—daily Bible verse and multi-day devotional series',
      'Prayer log to pray together, side by side',
      '"In Step" cooperative couples game—daily challenges, quick rounds, and 7-day journeys with synced reveals',
      'Live location sharing with places and geofences, tuned for battery efficiency',
      'One-tap Pulses to send a quick thinking-of-you, love-you, or praying-for-you nudge',
      'Native home-screen widgets (verse, next event, prayer prompt, streak) on iOS and Android',
      'Real-time partner sync over WebSockets and partner-activity push notifications',
      'Glass-morphic, dark, golden-ratio design with two themes (Aurora Dark + Rosewood)',
      'No AI—thoughtful, hand-curated, Christianity-rooted content',
      'One codebase for iOS, Android, and web (Expo + React Native Web)',
    ],
    image: `${base}images/projects/ourlee/home.jpg`,
    images: [
      `${base}images/projects/ourlee/home.jpg`,
      `${base}images/projects/ourlee/together.jpg`,
      `${base}images/projects/ourlee/calendar.jpg`,
      `${base}images/projects/ourlee/faith.jpg`,
      `${base}images/projects/ourlee/photos.jpg`,
    ],
    category: ['Mobile App', 'Web App', 'Faith'],
    status: { label: 'Closed Beta', color: 'info' },
    liveUrl: 'https://ourlee.app',
  ...
  },
  {
    ...
    title: 'Beyond25',
    description:
      'Your AI music curator—now on iOS, Android, and the web. Two ways to create: describe what you want in chat, or build visually in Canvas mode—stack ingredients (moods, eras, genres, artists, emojis) on a living, animated canvas and let the AI generate the mix. The AI researches, curates, and builds playlists you can sync to Apple Music or YouTube Music, or use Lite mode with no music account (catalog metadata, previews, and links). iOS purchases use Apple IAP; web subscriptions and credit packs use Stripe. Spotify connect, search, and save are not available to most users: Spotify\'s extended API path effectively requires very large scale (on the order of ~250K MAU). Premium Gemini research, larger playlists, a calmer Discover hub, and optional local Ollama round out the product.',
    longDescription:
      'Beyond25 is an AI-powered music curator built with Expo and React Native (TypeScript), targeting native and web from one codebase. There are two ways to create. In chat you describe the vibe and the app researches tracks, curates, and delivers a playlist inline. In Canvas mode you build visually—pile up "ingredients" (moods, eras, genres, artists, emojis, free tags) on a living, animated canvas that morphs in real time as you add to it, then hit generate and the same music-native AI turns the pile into a playlist (a bit like Genmoji, but for playlists). The app is live on the App Store and Google Play, and runs as a web app at beyond-25.com. Link Apple Music for full curation against your catalog, library context, and one-tap saves, or sign in with Google for YouTube Music to save playlists, like videos, and use your YouTube playlists or liked videos as chat context. Lite mode needs no music service: you still get AI playlists and public catalog metadata, with previews where Apple or other APIs allow, and library save stays off until you connect. A calmer, playable Discover hub surfaces featured and AI-curated playlists. Spotify connect, search, and save are not available to the general public because Spotify keeps third-party apps in restricted developer access until they qualify for extended API use—requirements that imply very large active audiences (roughly on the order of ~250K MAU). The app may still surface Spotify in settings for transparency; authorized accounts may use it only for internal testing. Powered by Gemini (premium) with optional Ollama locally. Dark mode, no ads, no selling of your data. iOS purchases go through Apple IAP; web subscriptions and credit packs go through Stripe.',
    technologies: [
      'React Native',
      'Expo',
      'TypeScript',
    ...
    features: [
      'Canvas mode — build a playlist visually by stacking ingredients (moods, eras, genres, artists, emojis) on a living, animated canvas; the AI generates from your pile (Genmoji-style, but for playlists)',
      'Chat — describe the vibe in words and get a curated playlist inline',
      'Research — AI-driven, music-native discovery before tracks land in your mix',
      'Discover hub — calmer, playable browsing of featured and AI-curated playlists',
      ...
      'Live on iOS, Android (Google Play), and the web from one codebase',
    ...
    status: { label: 'Live · iOS, Android & Web', color: 'success' },
    liveUrl: 'https://www.beyond-25.com',
    liveUrlLabel: 'Website',
    appStoreUrl: 'https://apps.apple.com/us/app/beyond25/id6759841636',
    playStoreUrl: 'https://play.google.com/store/apps/details?id=com.beyond25.app',
  },
  {
    id: 2,
    slug: 'eaglechair',
  ...
  },
  {
    ...
    title: 'NovaSwift',
    description:
      'A from-scratch native Swift/Metal rebuild of Escape Velocity Nova (2002), running on macOS, iPadOS, iOS, and tvOS. Reimplements the flight and combat simulation, AI, missions, economy, and resource parser from the original game—bring your own legally-owned data. Adds real-time co-op multiplayer over local Wi-Fi or Game Center, full MFi/Xbox/PlayStation controller support, a live Story Map, an in-app plug-in store, and iCloud save sync. A native Godot 4 port for Linux and Windows is underway. Public beta on TestFlight for all four Apple platforms.',
    longDescription:
      'NovaSwift is a fan-made, from-scratch Swift port of Escape Velocity Nova (Ambrosia Software / ATMOS, 2002)—not a wrapper or emulator, but a full reimplementation of the resource parser, flight and combat simulation, AI, missions, and economy, reading a player-supplied legally-owned copy of the original game data at runtime. It runs natively on macOS, iPadOS, iOS, and tvOS with touch and full MFi/Xbox/PlayStation controller support, and layers in features the 2002 original never had: host-authoritative co-op multiplayer over local Wi-Fi or Game Center, a live pannable Story Map, an in-app plug-in store for community total conversions, and iCloud sync for imported game data. Classic/Enhanced toggles keep a pure run faithful to 2002 while modern conveniences stay opt-in. The simulation core is portable Swift with minimal Apple-framework coupling, enabling an in-progress native Godot 4 frontend (via SwiftGodot) that will bring the same engine to Linux and Windows. Built with heavy AI-assisted development for both the engine and the resource-format reverse engineering. Public beta live on TestFlight for macOS, iPadOS, iOS, and tvOS.',
    technologies: [
      'Swift',
      'SwiftUI',
      'SpriteKit',
    ...
    features: [
      'From-scratch native rewrite of EV Nova’s flight, combat, AI, missions, and economy—~90% feature-complete',
      'Runs natively on macOS, iPadOS, iOS, and tvOS with touch- and controller-first UI',
      'Host-authoritative co-op multiplayer over local Wi-Fi (Multipeer) or Game Center',
      'Full MFi / Xbox / PlayStation controller support with remappable twin-stick flight',
      'Live pannable Story Map, in-app plug-in store, and Classic/Enhanced fidelity toggles',
      'iCloud sync for imported game data across devices',
      'In-progress native Godot 4 port (via SwiftGodot) bringing the engine to Linux and Windows',
    ],
    image: `${base}images/projects/novaswift/logo-banner.png`,
    images: [
      `${base}images/projects/novaswift/logo-banner.png`,
      `${base}images/projects/novaswift/flight-hud.png`,
      `${base}images/projects/novaswift/galaxy-map.png`,
      `${base}images/projects/novaswift/story-map.png`,
      `${base}images/projects/novaswift/multiplayer.png`,
      `${base}images/projects/novaswift/plugin-store.png`,
    ],
    category: ['Game Development', 'Desktop App', 'Mobile App'],
    status: { label: 'Public Beta', color: 'info' },
    liveUrl: 'https://sirstig.github.io/NovaSwift/',
    liveUrlLabel: 'Website',
    githubUrl: 'https://github.com/SirStig/NovaSwift',
  },
  {
    id: 1,
    slug: 'project-yoked',
    ...
    status: { label: 'Temporarily Shut Down', color: 'warning' },
    isPrivate: true,
  },
  {
    id: 3,
