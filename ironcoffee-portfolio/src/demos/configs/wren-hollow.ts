...
const wrenHollow: DemoConfig = {
  ...
  services: [
    {
      ...
      icon: 'calendar',
      body: 'Set up on Friday, get married on Saturday, clear out by Sunday lunch. No four hour window, no second party arriving behind you, nobody rushing the photographs because another couple is in the car park.',
    },
    {
  ...
  faq: [
    ...
    {
      q: 'Is there a curfew?',
      a: 'Music off at eleven, because the neighbors are a quarter mile away and we would like to stay on good terms with them. People usually end up round the fire until one.',
    },
    {
